...
/* config.html.twig */
class __TwigTemplate_17c63457c7f481163ec9376eceae7efcbd42a54e8d67d3ea585e458bc2b0cf3e extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["configuration"]) {
            ...
            if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => ("admin.configuration_" . $context["configuration"]), 1 => "admin.super"))) {
                ...
                if ((((($context["configuration"] != "system") && ($context["configuration"] != "site")) &&  !$this->getAttribute($this->getAttribute(($context["current_blueprints"] ?? null), "form", array()), "hidden", array())) && ( !twig_test_empty($this->getAttribute($this->getAttribute(($context["current_blueprints"] ?? null), "form", array()), "fields", array())) ||  !twig_test_empty($this->getAttribute($this->getAttribute(($context["current_blueprints"] ?? null), "form", array()), "field", array()))))) {
                    ...
                    // line 59
                    echo "                            <span>";
                    echo twig_escape_filter($this->env, ((($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter(($context["configuration_string"] ?? null)) == ($context["configuration_string"] ?? null))) ? (twig_capitalize_string_filter($this->env, $context["configuration"])) : ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter(($context["configuration_string"] ?? null)))), "html", null, true);
                    echo "</span>
                        </a>
                    ";
                }
...
{% endblock %}
", "config.html.twig", "/home/gus/Workspace/grav_nnb/user/plugins/admin/themes/grav/templates/config.html.twig");
    }
}
